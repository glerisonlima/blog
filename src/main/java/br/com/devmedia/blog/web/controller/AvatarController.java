...
import br.com.devmedia.blog.services.AvatarService;
import br.com.devmedia.blog.services.UsuarioService;
	...
	public ResponseEntity<byte[]> loadAvatar(@PathVariable("id") Long id){
		...
		try{
			...
			try {
				...
				LOG.error("Ocorreu um erro ao fechar o stram do arquivo!", e.getCause());
			}
		}
		return null;
	}
